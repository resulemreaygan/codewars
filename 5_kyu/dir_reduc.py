...
"""
Project Description: Directions Reduction
...
"NORTH" and "SOUTH" are not directly opposite but they become directly opposite after the reduction of "EAST" and
...
def dir_reduc(arr):
    ...
    for i in arr:
        if result and dir_dict[i] == result[-1]:
            result.pop()
        else:
            result.append(i)
